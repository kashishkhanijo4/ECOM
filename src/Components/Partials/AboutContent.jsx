              ...
              <div className="h-100">
                <div className="border-start border-5 border-primary ps-4 mb-5">
                  ...
                  <h1 className="display-6 mb-0">
                    100 Genuin Products or Top Brands!
                  </h1>
                </div>
                <p>
                  ...
                  <div className="row g-4">
                    ...
                    <div className="col-sm-4 d-flex wow fadeIn" data-wow-delay="0.3s">
                      <i
                        className="fa fa-check fa-2x text-primary flex-shrink-0 me-3"
                      ></i>
                      <h6 className="mb-0">24/7 hours support</h6>
                    </div>
        ...
        <div className="row g-0">
          <div className="col-xl-3 col-sm-6 wow fadeIn" data-wow-delay="0.1s">
            <div className="position-relative">
              <img className="img-fluid w-100" src="/images/banner10.jpg" style={{ height: 350, width: "100%" }} alt="" />
              <div className="facts-overlay">
                <h1 className="display-1">01</h1>
                <h4 className="text-white mb-3">Top Brands</h4>
                <p className="text-white">
                  Adidas Mufti Cobb Tommy Hilfiger US Polo Zara Gucci Nike Puma etc
                </p>
          ...
          <div className="col-xl-3 col-sm-6 wow fadeIn" data-wow-delay="0.3s">
            <div className="position-relative">
              <img className="img-fluid w-100" src="/images/banner9.jpg" style={{ height: 350, width: "100%" }} alt="" />
              <div className="facts-overlay">
          ...
          <div className="col-xl-3 col-sm-6 wow fadeIn" data-wow-delay="0.5s">
            <div className="position-relative">
              <img className="img-fluid w-100" src="/images/banner8.jpg" style={{ height: 350, width: "100%" }} alt="" />
              <div className="facts-overlay">
          ...
          <div className="col-xl-3 col-sm-6 wow fadeIn" data-wow-delay="0.7s">
            <div className="position-relative">
              <img className="img-fluid w-100" src="/images/banner7.jpg" style={{ height: 350, width: "100%" }} alt="" />
              <div className="facts-overlay">
